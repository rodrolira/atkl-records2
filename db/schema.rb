...
ActiveRecord::Schema[7.1].define(version: 2024_01_10_235841) do
  ...
  create_table "eps", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["release_id"], name: "index_eps_on_release_id"
  end
  ...
  create_table "multimedia_items", force: :cascade do |t|
    t.string "title"
    t.string "content_type"
    t.string "link"
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_multimedia_items_on_user_id"
  end
  ...
  add_foreign_key "eps", "releases"
  add_foreign_key "events", "users"
  add_foreign_key "multimedia_items", "users"
